...
<!-- DW6 -->
<head>
<title>BUSA353BusinessModelCanvas03</title>
...
<table width="100%" border="1" cellspacing="1" cellpadding="1">
  ...
  <tr bgcolor="#00FFFF">
    ...
    <td colspan="2"> Assignment:
      <input  name="Assignment" type="text" value="BMC03"/></td>
  </tr>
  <tr bgcolor="#00FFFF">
    <td colspan="3">&nbsp;</td>
  </tr>
...
<h1 align="center">Business Model Canvas-Design02</h1>
<h2 align="center">&nbsp;</h2>
<p  align="left"> Read: <br>
  Business Model Generation: pages 160 to 199<br />
</p>
<hr />
<hr />
...
<p><strong><font color="#000000">Use the techniques in the Design section of the book to develop a business model using  the Prototyping (page 160),  Storytelling (page 170) or Scenarios (page 180) technique. <br>
  The business can be anything your group decides upon.
        <br>
    <br />
</font></strong><strong>Refer to the <a href="../../BusinessModelCanvas/business_model_canvas_GuidelinesPoster.pdf" target="_blank">Business 
...
<p>10. (<strong>100</strong>)&nbsp; When done, save a copy of your product's business model canvas as a .pdf file and 
  upload it to the D2L Assignment Folder &quot;BMC03&quot;&nbsp;</p>
