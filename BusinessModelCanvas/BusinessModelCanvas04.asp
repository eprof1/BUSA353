...
<!-- DW6 -->
<head>
<title>BUSA353BusinessModelCanvas04</title>
...
<table width="100%" border="1" cellspacing="1" cellpadding="1">
  ...
  <tr bgcolor="#00FFFF">
    ...
    <td colspan="2"> Assignment:
      <input  name="Assignment" type="text" value="BMC04"/></td>
  </tr>
  <tr bgcolor="#00FFFF">
    <td colspan="3">&nbsp;</td>
  </tr>
...
<h1 align="center">Business Model Canvas-Strategy01</h1>
<h2 align="center">&nbsp;</h2>
<p  align="left"> Read: <br>
  Business Model Generation: pages 200 to 225<br />
</p>
<hr />
<hr />
...
<p><strong><font color="#000000">Use the techniques in the Strategy section of the book to develop a business model  using either Business Model Environment  (page 200),   or Evaluating Business Model (page 212). <br>
  The business can be anything your group decides upon from the pharmaceutical industry if you choose the Business Model Environment, or something for Amazon (drone delivery) if you choose Evaluating Business Model.
  <br />
</font></strong></p>
...
<p>10. (<strong>100</strong>)&nbsp; When done, save a copy of your product&#39;s business model canvas as a .pdf file and 
  upload it to the D2L Assignment Folder &quot;BMC04&quot;&nbsp;</p>
<p>11. (<strong>100</strong>) After you publish this assignment to your website (https://classes.winona.edu/20175002259/.....) open this webpage using a browser and verify the website and webpage functions correctly, then press the submit button.<br />
